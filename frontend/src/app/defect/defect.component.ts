        ...
        <div class="defect-edit">
            <div>
                ...
                <div class="actions">
                    ...
                    <a mat-button *ngIf="!defect.id" [disabled]="!dataValid() || saving" (click)="save()">Save and
                        New</a>
                </div>
            </div>
            <div class="title-row">
            ...
            <div *ngIf="defect.id" class="comments">
                ...
                <form (ngSubmit)="comment(message.value); message.value = '';">
                    <div class="comment-field">
                        ...
                        <button mat-icon-button type="submit" [disabled]="!message.value.length">
...
export class DefectComponent {
    ...
    save() {
        const data = JSON.parse(JSON.stringify(this.defect));
